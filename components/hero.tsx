    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <span className="font-semibold text-accent">Machine Learning Enthusiast</span>{" "}
          transforming raw data into powerful insights, predictive models, and data-driven business strategies.
        </p>
      ...
      >
        <a
          href="#about"
          className="group flex flex-col items-center gap-2 text-muted-foreground transition-colors duration-300 hover:text-primary"
        >
