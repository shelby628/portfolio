        ...
        <div className="flex flex-col items-center gap-16 lg:flex-row lg:items-start lg:justify-between">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
              {"Looking for a data analyst or ML enthusiast to turn your raw data into actionable intelligence? I'm always open to discussing data-driven projects, machine learning challenges, or opportunities to drive impact through analytics."}
            </p>
            <Link
              href="/contact"
