        ...
        <div className="flex flex-col items-center gap-16 lg:flex-row lg:items-start">
          ...
          >
            <p className="text-lg leading-relaxed text-muted-foreground">
              ...
              driven by the power of data to solve real-world problems. My core expertise lies in{" "}
              <span className="font-semibold text-accent">
                Data Analysis and Machine Learning
              </span>
              , where I transform complex datasets into clear, actionable insights that drive smarter business decisions.
            </p>
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
              ...
              to uncovering hidden patterns in data, I bring a blend of analytical rigor and creative problem-solving to every project. Whether it is fraud detection with machine learning or sales forecasting with statistical modeling, I am committed to turning data into impact.
            </p>
